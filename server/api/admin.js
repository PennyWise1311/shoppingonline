...
// daos
const AdminDAO = require('../models/AdminDAO');                    // admin DAO 
const CategoryDAO = require('../models/CategoryDAO');              // CATEGORY DAO 
const ProductDAO = require('../models/ProductDAO');               // PRODUCT DAO 
const OrderDAO = require('../models/OrderDAO');                   // Order DAO 
const CustomerDAO = require('../models/CustomerDAO');             // Customer DAO 
//                                                categoryDAO update                                  
router.get('/categories', JwtUtil.checkToken, async function (req, res) {
    const categories = await CategoryDAO.selectAll();
    res.json(categories);
});
//                                                category UPDATE " ADD NEW " BUTTON 
...
// product                                   add new button in products  
...
// product                                   update button in products 
...
//products                                    delete button in products 
